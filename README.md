...
More information can be found in [the whitepaper](https://github.com/BenH11235/KeyReuseFinder/blob/master/exploiting-stream-cipher-key-reuse-in-malware-traffic.pdf) and in the recorded talk ['Finding the Weak Crypto Needle in a Byte Haystack'](https://www.youtube.com/watch?v=GQOam3XJdWg), given at 31C3 (31st Chaos Communication Congress in Hamburg).
